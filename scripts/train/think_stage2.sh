...
# Think-Gen Stage 2: Refinement with constant LR
...
JOB_NAME="lightfusion_think_stage2"
OUTPUT_DIR="${OUTPUT_BASE_DIR}/${JOB_NAME}"
CHECKPOINT_DIR="$OUTPUT_DIR/checkpoints"
RESUME_FROM="${OUTPUT_BASE_DIR}/lightfusion_think_stage1/checkpoints"
mkdir -p $OUTPUT_DIR
...
torchrun \
  ...
  --dataset_config_file data/configs/think_stage2.yaml \
  --vlm_path $VLM_PATH \
