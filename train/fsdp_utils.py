...
from modeling.wan22_modules.model import PackedWanAttentionBlock
from modeling.lightfusion.qwen25vl_navit_fusion import Qwen2_5_VLDecoderLayer, QwenMMAttentionLayer
from modeling.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLVisionBlock, Qwen2_5_VisionTransformerPretrainedModel
    ...
    return FSDP(
        ...
        auto_wrap_policy=functools.partial(
            ...
            transformer_layer_cls={
                PackedWanAttentionBlock,
                Qwen2_5_VLDecoderLayer,
                QwenMMAttentionLayer
            },
        ),
